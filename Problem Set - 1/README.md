...
#### Day-1 [06/04/23] **Binary Search**
1. [1011. Capacity To Ship Packages Within D Days](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/)

2. [1482. Minimum Number of Days to Make m Bouquets](https://leetcode.com/problems/minimum-number-of-days-to-make-m-bouquets//)

3. [1760. Minimum Limit of Balls in a Bag](https://leetcode.com/problems/minimum-limit-of-balls-in-a-bag/)

_________________

#### Day-2 [07/04/23] **Recursion**
...
#### Day-3 [08/04/23] **Backtracking**
1. [39. Combination Sum](https://leetcode.com/problems/combination-sum/)

2. [79. Word Search](https://leetcode.com/problems/word-search/)

3. [1947. Maximum Compatibility Score Sum](https://leetcode.com/problems/maximum-compatibility-score-sum/description/)

_________________
#### Day-4 [09/04/23] **Sorting**
1. [451. Sort Characters By Frequency](https://leetcode.com/problems/sort-characters-by-frequency/)

2. [881. Boats to Save People](https://leetcode.com/problems/boats-to-save-people/)

3. [2279. Maximum Bags With Full Capacity of Rocks](https://leetcode.com/problems/maximum-bags-with-full-capacity-of-rocks/description/)
